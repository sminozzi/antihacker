...
$antihacker_pcs_settings_config = array();

/**
* Base Directory Setting
*/
$antihacker_pcs_settings_config['base_dir'] = __DIR__ . '/';

/**
* Base URI Settings
* Use WordPress' plugins_url to set this if not a theme.
*/
$antihacker_pcs_settings_config['base_uri'] = plugins_url( 'settings', dirname( __FILE__ ) ) . '/';

/**
* Requred Classes and Libraries
*/
// get_template_part($antihacker_pcs_settings_config['base_dir'] . 'containers');
// get_template_part($antihacker_pcs_settings_config['base_dir'] . 'fields');
// get_template_part($antihacker_pcs_settings_config['base_dir'] . 'factories');
// get_template_part($antihacker_pcs_settings_config['base_dir'] . 'page-builders');
