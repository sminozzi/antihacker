<?php namespace antihacker_BillInstall;
//
/**
 * @ Author: Bill Minozzi
...
*/
use antihacker_BillDiagnose\MemoryChecker;
use antihacker_BillDiagnose\ErrorChecker;
if (!defined("ABSPATH")) {
...
add_action('wp_loaded', 'antihacker_bill_install');
*/
...
$finished_time = sanitize_text_field(get_option("bill_minozzi_pre_checkup_finished", "0"));
...
/////////////// Class Begin //////////////////
class antihacker_Bill_Class_Plugins_Install
{
    ...
    public function pre_checkup_page_content()
    {
        ...
        switch ($step) { case 1: ?> 
                <div class="bill_install_wrap">
                    ...
                    $diagnose_instance = new antihacker_Bill_Class_Plugins_Install(
...
$plugin_install = new antihacker_Bill_Class_Plugins_Install(
    $plugin_slug,
    $notification_url,
    $notification_url2,
    $plugin_text_domain,
