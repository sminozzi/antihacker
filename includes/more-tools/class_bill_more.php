<?php // namespace antihacker_BillMore {
if (!defined("ABSPATH")) {
    exit();
...
// >>>>>>>>>>>>>>>>>>>>>>>
*/
class antihacker_Bill_Minozzi_Add_Ajax_Url
{
...
$antihacker_bill_minozzi_add_ajax_url = new antihacker_Bill_Minozzi_Add_Ajax_Url();
class antihacker_Bill_show_more_plugins
{
    //
    public function __construct()
    {
        ...
        // add_action('wp_ajax_bill_install_plugin2', array('\antihacker_BillMore\Bill_show_more_plugins', 'bill_install_plugin2'));
        ...
        // work add_action('wp_ajax_bill_install_plugin2', '\antihacker_BillMore\bill_install_plugin2');
    }
...
$show_more_plugins = new antihacker_Bill_show_more_plugins();
// } // end namespace
class antihacker_PluginInstaller
{
    public function __construct()
    {
    ...
    public function bill_install_plugin2()
    {
        ...
        $plugin = $slug;
        $skin = new \antihacker_bill_install_QuietSkin(["api" => $api]);
...
$plugin_installer = new antihacker_PluginInstaller();
//$plugin_installer->install_plugin();
require_once ABSPATH . "wp-admin/includes/plugin-install.php";
require_once ABSPATH . "wp-admin/includes/class-wp-upgrader.php";
class antihacker_bill_install_QuietSkin extends \WP_Upgrader_Skin
{
    public function __construct()
    {
        parent::__construct();
...
$quiet_skin = new antihacker_bill_install_QuietSkin();
