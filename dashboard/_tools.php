...
echo esc_attr__('If you need support, please, copy and paste the info below in our', 'antihacker'); ?> &nbsp;
<a href="https://BillMinozzi.com/support"><?php echo esc_attr__('Support Site', 'antihacker'); ?></a>
<br><br>

<?php

antihacker_sysinfo_display();

echo '</big>';

function antihacker_sysinfo_display()
{
...
?>
    <textarea style="height:60vh" ; readonly="readonly" onclick="this.focus(); this.select()"><?php echo esc_attr(antihacker_sysinfo_get()); ?></textarea>
<?php
}
...
{
    global $wpdb;
    global $antihacker_userAgentOri;
    ...
    $return .= 'Plugin Dir:                  ' . ANTIHACKERVERSION . "\n";
